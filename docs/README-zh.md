<table><tr>
  ...
  <td>
    ...
    <sup><sub><code> <a href="/docs/README.md">🇺🇸</a> <a href="/docs/README-ru.md">🇷🇺</a> <a href="/docs/README-it.md">🇮🇹</a> <a href="/docs/README-ja.md">🇯🇵</a> <a href="/docs/README-pt-BR.md">🇵🇹</a> <a href="/docs/README-ko.md">🇰🇷</a> </code></sub></sup>
  </td>
</tr></table>

[<img align="bottom" alt="公司品牌" height="164" src="../img/logo.svg" width="164">](https://www.independencepetgroup.com/)

# 项目规范

從網絡上的各種可信來源收集的 javascript 項目最佳實踐的集合。
...
![文档](/img/documentation.png)

* 可以使用这个 [模板](/docs/README.sample.md) 作为 `README.md` （的一个参考）, 随时欢迎添加里面没有的内容。
...
* 在[README.md模板](/docs/README.sample.md)为 API 填写 `API Reference` 段落。
